...
__authors__ = [ 'Rahul_Sawhney',  ]
#$ exec(False) if not [ __main_module__.__dict__() or all('Rahul_Sawhney',) in __authors__ ]   
...
# Python Imports
import typing
__name__: typing.__name__ = '__main__', '__main_module__', '__temp_name_space__'
...
#from numpy.distutils.npy_pkg_config import args
...
class CovidAnalysis:
    ...
    @classmethod
    def image_segment_plot(cls, ) -> _plot:
        ...


##################################################################################################
#@: Class DataPreprocess
# @_move_to_cpp(*args, **kwargs)
# @_transform_to_cpp(*args, **kwargs)
class CovidPreprocess:
    ...
    @classmethod
    def invertImage(cls, *args: list[Any], 
                         **kwargs: dict[Any, Any]) -> torch.Tensor[_transform]:
        ...


    @classmethod
    def horizontal_flip(cls, *args: list[Any], 
                             **kwargs: dict[Any, Any]) -> torch.Tensor[_transform]:
        ...


    @classmethod
    def vertical_flip(cls, *args: list[Any], 
                           **kwargs: dict[Any, Any]) -> torch.Tensor[_transform]:
        ...


    @classmethod
    def random_crop(cls, *args: list[Any], 
                         **kwargs: dict[Any, Any]) -> torch.Tensor[_transform]:
        ...


    @classmethod
    def denormalize_image(cls, *args: list[Any], 
                               **kwargs: dict[Any, Any]) -> torch.Tensor[_transform]:
        ...


    @classmethod
    def image_augumentation(cls, *args: list[Any], 
                                 **kwargs: dict[Any, Any]) -> torch.Tensor[_transform]:
        ...


    @classmethod
    def image_segmentation(cls, *args: list[Any], 
                                **kwargs: dict[Any, Any]) -> torch.Tensor[_transform]:
        ...

    
    @classmethod
    def image_burr(cls, *args: list[Any], 
                        **kwargs: dict[Any, Any]) -> torch.Tensor[_transform]:
        ...

    
    @classmethod
    def image_zoom_unzoom(cls, *args: list[Any], 
                               **kwargs: dict[Any, Any]) -> torch.tensor[_transform]:
        ...
...
if __name__.__contains__('__main__'):
    ...
    path: _path = "C:\\Users\\Lenovo\\OneDrive\\Desktop\\__temp\\Covid19-dataset\\"
    #C:\Users\Lenovo\OneDrive\Desktop\__temp\Covid19-dataset
    sub_path: list[str] = ["test", "train"]
    
    training_data = CovidDataset(path= path, sub_path= sub_path[1], batch_size= 16)

    testing_data = CovidDataset(path= path, sub_path= sub_path[0], batch_size= 16)
